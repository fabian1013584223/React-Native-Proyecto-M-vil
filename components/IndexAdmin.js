  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ marginBottom: 40 }}>
          <Text style={{ color: '#0a58ca', fontSize: 24, textAlign: 'center',lineHeight:'2'}}>Administrador</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ShowCliente')}>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
          BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowCategoria')}>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
           BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowFactura')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Factura</Text>
                </TouchableOpacity>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
           BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('ShowPedidos')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Pedidos</Text>
                </TouchableOpacity>
          ...
          style={{ alignItems: 'center',alignSelf:'center',width: 150,marginBottom: 32,paddingBottom: 25,
           BottomWidth:4,borderRadius:5,backgroundColor: '#0d6efd' }}>
            <TouchableOpacity onPress={() => navigation.navigate('RegistroEmpleados')}>
                    <Text style={{ textAlign: 'center', color: '#FFFFFF',fontSize:17,lineHeight:'2' }}>Registro Empleados</Text>
                </TouchableOpacity>
