    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ padding: 20 }}>
        <View style={{ marginBottom: 40 }}>
          <Text style={{ color: '#0a58ca', fontSize: 28, textAlign:'center', fontWeight:'500'}}>Derechos De Autor</Text>
          <Text style={{ fontFamily: 'sans-serif', fontSize: 17, fontWeight: 16,textAlign:'center', lineHeigth:24}}>Los derechos de autor están reservados por  Diana Lorena Yepes Córdoba. Todo el contenido de este proyecto,aprendiz del Sena del Centro de Electricidad, Electrónica y Telecomunicaciones, en el programa de Análisis y Desarrollo de Software (ADSO), Ficha 2558108, año 2023.</Text>
        </View>
